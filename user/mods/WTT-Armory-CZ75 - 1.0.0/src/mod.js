...
class WTTArmoryCZ75 {
    ...
    displayCreditBanner() {
        ...
        this.Instance.logger.log(`[${this.modName}] Supreme Czechnology Acquired`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] ------------------------------------------------------------------------`, LogTextColor_1.LogTextColor.GREEN);
    }
}
module.exports = { mod: new WTTArmoryCZ75() };
